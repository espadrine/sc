...
exports.on = exports.add = (function () {

  // The exports.add function is the following.
  var adder = function (channel, callback) {
  	exports.Server.Channels[channel] = callback;
  };

  exports.Server.Channels = {};    // This will be extended by the add function.
  
  return adder;
})();

// Similarly engineered mechanics to make a Server-Sent Events machine.
exports.addEventSender = function (channel, callback) {
  exports.add (channel, function (json) {
    var chanlistener = function () {
    };
    chanlistener.name = '$-' + channel;
    return chanlistener;
  });
};
    ...
    try {
      ...
      if (/^\/\$/.test (path)) {
        ...
        var gotrequest = function (chunk) {
          ...
          if (exports.Server.Channels[action]) {
            // If an action *is* defined,
            // then we send back the data it gives us.
            (function sendingbackdata (sentback) {
              ...
              } else if (typeof sentback === 'object') {
            ...
            }) (exports.Server.Channels[action] (query, res));
          } else {
            res.end ('404');
          }
